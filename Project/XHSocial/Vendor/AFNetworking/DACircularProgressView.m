...
- (void)initailize {
    ...
    self.trackTintColor = [UIColor colorWithRed:0.325 green:0.466 blue:0.835 alpha:1.000];
    self.progressTintColor = [UIColor colorWithRed:0.346 green:0.814 blue:1.000 alpha:1.000];
}
